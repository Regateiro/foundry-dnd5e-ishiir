 ...
 * @param {boolean} [options.expert=false]             Allow Expert to reroll ones on this roll?
...
export default class D20Roll extends Roll {
  ...
  configureModifiers() {
    ...
    // Halfling Lucky / Expert Feat
    if ( this.options.halflingLucky || this.options.expert ) d20.modifiers.push("r1=1");
